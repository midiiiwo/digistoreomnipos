...
export function getMerchantSelectedDiscountOutletDetails(
  merchant,
  discount_id
) {
  return Api.get(
    `/discounts/discount/${merchant}/${discount_id}/outlets/ids/list`
  );
}

export function getMerchantSelectedDiscountProductApply(merchant, discount_id) {
  return Api.get(
    `/discounts/discount/${merchant}/${discount_id}/product/ids/list`
  );
}
...
export function getMerchantRidersAll(merchant, outlet) {
  return deliveryApi.get(`admin/company/${merchant}/riders/${outlet}`);
}

export function getMerchantDeliveryWindow(merchant, outlet) {
  return deliveryApi.get(`admin/deliveryWindows/${merchant}/${outlet}`);
}
