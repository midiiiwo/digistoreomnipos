    ...
    <View style={{ flex: 1 }}>
      ...
      >
        ...
        <DrawerItem
          ...
          label="Checkout"
          icon={({ color }) => <Checkout height={30} width={30} />}
          inactiveBackgroundColor="#fff"
          activeBackgroundColor="#3C79F5"
          activeTintColor="#fff"
          inactiveTintColor="#4C4C4C"
        ...
        <DrawerItem
          ...
          label="Orders"
          icon={({ color }) => <Order height={30} width={30} />}
          inactiveBackgroundColor="#fff"
          activeBackgroundColor="#3C79F5"
          activeTintColor="#fff"
          inactiveTintColor="#4C4C4C"
        ...
        <DrawerItem
          ...
          label="Products"
          icon={({ color }) => <Products_ height={30} width={30} />}
          inactiveBackgroundColor="#fff"
          activeBackgroundColor="#3C79F5"
          activeTintColor="#fff"
          inactiveTintColor="#4C4C4C"
        ...
        <DrawerItem
          ...
          label="Transactions"
          icon={({ color }) => <Transactions height={30} width={30} />}
          inactiveBackgroundColor="#fff"
          activeBackgroundColor="#3C79F5"
          activeTintColor="#fff"
          inactiveTintColor="#4C4C4C"
          ...
          <DrawerItem
            labelStyle={[
              styles.label, // Keep your existing label styles
              {
                ...
                fontWeight:
                  activeItem === "Manage Deliveries" ? "bold" : "normal", // Bold text if active
              },
            ]}
            style={{
              paddingVertical: -10,
              marginVertical: -1.5,
              backgroundColor:
                activeItem === "Manage Deliveries" ? "#3C79F5" : "#fff",
              borderRadius: 15,
            }}
            label="Manage Deliveries"
            icon={({ color }) => <DrawerDeliveries height={30} width={30} />}
            inactiveBackgroundColor="#fff"
            activeBackgroundColor="#3C79F5"
            activeTintColor="#fff"
            inactiveTintColor="#4C4C4C"
        ...
        {isAdmin && (
          <DrawerItem
            ...
            label="Insight"
            icon={({ color }) => <Analytics_ height={30} width={30} />}
            inactiveBackgroundColor="#fff"
            activeBackgroundColor="#3C79F5"
            activeTintColor="#fff"
            inactiveTintColor="#4C4C4C"
        ...
        {isAdmin && (
          <DrawerItem
            ...
            label="Settings"
            icon={({ color }) => <Settings height={30} width={30} />}
            inactiveBackgroundColor="#fff"
            activeBackgroundColor="#3C79F5"
            activeTintColor="#fff"
            inactiveTintColor="#4C4C4C"
        ...
        <DrawerItem
          ...
          label="Help"
          icon={({ color }) => <Support height={30} width={30} />}
          inactiveBackgroundColor="#fff"
          activeBackgroundColor="#3C79F5"
          activeTintColor="#fff"
          inactiveTintColor="#4C4C4C"
        ...
        >
          <View style={{ flexDirection: "row", alignItems: "center" }}>
            ...
            <Text style={[styles.label, { marginLeft: 12 }]}>Logout</Text>
          </View>
        </Pressable>
      </DrawerContentScrollView>
    </View>
