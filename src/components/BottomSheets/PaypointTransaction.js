              ...
              <Pressable
                ...
                onPress={() => {
                  if (airtime.includes(CHANNEL)) {
                    ...
                    props.payload.navigation.navigate('Airtime', {
                      airtimePreviousData,
                  ...
                  if (bills.includes(CHANNEL)) {
                    props.payload.navigation.navigate('Bill Details', {
                      bill: props.payload.name,
                      billCode: CHANNEL,
                  ...
                  if (sendMoney.includes(CHANNEL)) {
                    ...
                    props.payload.navigation.navigate('Send Money', {
                      sendMoneyDetails,
                      bill: props.payload.name,
                      billCode: 'S' + CHANNEL,
                      lookup: 'S' + CHANNEL,
