...
function InvoiceVariantSheet({ sheetId, payload }) {
  ...
  return (
    <ActionSheet
      ...
      <View>
        <Pressable
          onPress={() => SheetManager.hide('Invoice variant')}
      ...
      <View style={styles.btnWrapper}>
        <PrimaryButton
          style={styles.btn}
          handlePress={() => {
            console.log('payyyyy', selectedVariants);
            if (payload.product_has_property_variants === 'YES') {
              ...
              productVariants.forEach(i => {
                ...
                if (track) {
                  ...
                  SheetManager.hide('Invoice variant');
                }
              });
              return;
            }
            ...
            // toast.show('Variants selection does not exist', {
            //   placement: 'top',
            // });
            // navigation.goBack();
          }}>
...
export default InvoiceVariantSheet;
