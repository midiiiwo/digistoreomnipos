...
import { changeStoreDeliveryConfig } from '../api/merchant'; // Update with your actual API file path

export const useChangeStoreDeliveryConfig = (handleSuccess) => {
    const client = useQueryClient();

    return useMutation(
        async (payload) => {
            const response = await changeStoreDeliveryConfig(payload.merchant, payload);
