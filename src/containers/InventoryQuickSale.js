...
const InventoryQuickSale = ({ navigation, route }) => {
  const { addToCart, addDescription, setQuickSaleSubTotal, clearAmount } =
    useActionCreator();
  const { description, channel, amount, subTotal } = useSelector(
...
export default InventoryQuickSale;
