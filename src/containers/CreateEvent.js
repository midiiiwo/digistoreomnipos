        ...
        <ScrollView style={styles.main}>
          ...
          <Pressable
            ...
            style={{
              ...
              paddingVertical: 12,
              alignItems: 'center',
              borderColor: !state.eventLocation ? '#EB455F' : '#B7C4CF',
              borderWidth: 0.9,
              // borderStyle: 'dashed',
              marginBottom: 8,
              borderRadius: 4,
        ...
        <PrimaryButton
          ...
          handlePress={() => {
            if (
              ...
              state.eventCode.length === 0 ||
              state.eventDescription.length === 0 ||
              !state.eventLocation ||
              state.eventStartDate.length === 0 ||
              state.eventEndDate.length === 0 ||
              state.eventStartTime.length === 0
            ) {
              setShowError(true);
              return;
            }
          }}>
          {addCategory.isLoading ? 'Loading' : 'Save Event'}
        </PrimaryButton>
      </View>
    </View>
  );
