...
import { useDeleteMerchantRouteDistance } from "../hooks/useDeleteMerchantRouteDistance ";
...
const ManageRoutesDistance = () => {
  ...
  const { mutate } = useDeleteMerchantRouteDistance(setDeleteStatus);
        ...
        <FlatList
          ...
          ListHeaderComponent={() => (
            <View style={styles.headerRow}>
              <Text
                style={[styles.headerText, { flex: 0.5, textAlign: "left" }]}
              >
                #
              </Text>
              <Text
          ...
          renderItem={({ item, index }) => {
            ...
            return (
              <View style={styles.itemRow}>
                <Text
                  style={[styles.cellText, { flex: 0.5, textAlign: "left" }]}
                >
                  {index + 1}
                </Text>
                <Text
                  style={[styles.cellText, { flex: 2, textAlign: "center" }]}
                >
                  {item.start_distance}
                  {"  "}-{"  "}
                  {item.end_distance}
                ...
                <Text
                  style={[styles.rateText, { flex: 1, textAlign: "center" }]}
                >
                  {item.price}
                </Text>
                <Pressable
...
export default ManageRoutesDistance;
